...
export default {
  ...
  computed: {
    ...
    fortuneTellerBottomImgStyle() { return { width: '100%', height: '100%', position: 'absolute', left: 0, top: 0, pointerEvents: 'none', filter: 'brightness(1.5) contrast(0.8) blur(0.5px)', transform: 'rotate(180deg)' } },
